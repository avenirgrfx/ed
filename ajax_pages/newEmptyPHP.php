		...
		while($strRsCategory=mysql_fetch_object($strRsCategoryArr))
		{
			...
			while($strRsSubCat1=mysql_fetch_object($strRsSubCat1Arr))
			{
				...
				while($strRsSubCat2=mysql_fetch_object($strRsSubCat2Arr))
				{
					...
					print "<li><span style='$strHasNodeStyle' onclick=ShowImages('".$strRsSubCat2->system_id."')>".$strRsSubCat2->system_name."</span>&nbsp;&nbsp;&nbsp;&nbsp;<span style='width: 100%' id='Image-" . $strRsSubCat2->system_id . "'></span></li>";
				}
				print "</ul></li>";
