...
if(isset($_POST['package_id']) && !empty($_POST['package_id'])){
    $strSQL="delete from t_product_package where product_package_id=".$_POST['package_id'];
    $DB->Returns($strSQL);
}
?>
...
{
	$.post("<?php echo URL ?>ajax_pages/product_package.php",
    {
        package_id: id,
    },
...
?>
        ...
        <td valign="top" ><a href="#">Edit</a> | <a href="javascript:Delete_Package('<?php echo $strRsPackages->product_package_id?>')">Delete</a></td>
    </tr>
<?php }?>
</table>
