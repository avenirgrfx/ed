...
<div style="float:left; text-decoration:underline; margin-left:10px; width:60px; padding:2px 5px;">$/GLN</div>
<div class="clear"></div>

<div class="gray_box_for_value" style="float:left; width:140px;"><?=number_format($w_year, 0);?> GLN</div>
<div class="gray_box_for_value" style="float:left; margin-left:10px; width:140px;"><?=number_format($billing_water_consumption, 0);?> GLN</div>
<div class="gray_box_for_value" style="float:left; margin-left:10px; width:80px;">$<?=number_format($billing_water_cost, 0);?></div>
<div class="gray_box_for_value" style="float:left; margin-left:10px; width:60px;">$<?=number_format($billing_water_cost/$billing_water_consumption, 2);?></div>
<div class="clear" style="margin-top:3px;"></div>

<br>

<div style="float:left; width:150px; text-decoration:underline;">WATER ACCOUNTS</div>
<div style="float:left; text-decoration:underline; margin-left:10px; width:140px; padding:2px 5px;">BILLED CONSUMPTION</div>
<div style="float:left; text-decoration:underline; margin-left:10px; width:80px; padding:2px 5px;">BILLED COST</div>
<div style="float:left; text-decoration:underline; margin-left:10px; width:60px; padding:2px 5px;">$/GLN</div>
<div class="clear"></div>
...
while($strWaterAccount=mysql_fetch_object($strWaterAccountArr)) { ?>
    ...
    <div style="float:left; margin-left:14px; width:140px;"><?=number_format($strWaterAccount->consumption, 0);?> GLN</div>
    <div style="float:left; margin-left:20px; width:80px;">$<?=number_format($strWaterAccount->cost, 0);?></div>
    <div style="float:left; margin-left:20px; width:60px;">$<?=number_format($strWaterAccount->cost/$strWaterAccount->consumption, 2);?></div>
    <div class="clear" style="margin-top:3px;"></div>
<?php $i++; } ?>