...
<div class="gray_box_for_value" style="float:left; width:140px;"><?=number_format($e_year, 0);?> kWh</div>
<div class="gray_box_for_value" style="float:left; margin-left:10px; width:140px;"><?=number_format($billing_electric_consumption, 0);?> kWh</div>
<div class="gray_box_for_value" style="float:left; margin-left:10px; width:80px;">$<?=number_format($billing_electric_cost, 0);?></div>
<div class="gray_box_for_value" style="float:left; margin-left:10px; width:60px;">$<?=number_format($billing_electric_cost/$billing_electric_consumption, 2);?></div>
...
while($strElectricAccount=mysql_fetch_object($strElectricAccountArr)) { ?>
    ...
    <div style="float:left; margin-left:14px; width:140px;"><?=number_format($strElectricAccount->consumption, 0);?> kWh</div>
    <div style="float:left; margin-left:20px; width:80px;">$<?=number_format($strElectricAccount->cost, 0);?></div>
    <div style="float:left; margin-left:20px; width:60px;">$<?=number_format($strElectricAccount->cost/$strElectricAccount->consumption, 2);?></div>
    <div class="clear" style="margin-top:3px;"></div>
<?php $i++; } ?>
