...
?>
    <div id="ghg_given_dateline" style="float: left; width: 68%;">
    ...
    <div id="ghg_current_month" style="float: left; width: 32%;">
        <div style="float:left; font-weight:bold; font-size:14px; width:70px; margin-left:5px; padding: 2px 0;"><?= date('F', strtotime($_GET['from_date'])) ?></div>
        <div style="float:left; font-weight:bold; font-size:14px; width:70px; margin-left:5px; padding: 2px 0;">Baseline</div>
        <div class="clear" style="border-bottom:1px solid #DDDDDD; margin:5px 0px;"></div>

        <div style="float:left; width:70px; margin-left:5px; padding: 2px 0;"><?php $emm = $e_consumption*$co2; echo $emm>4000?number_format($emm/2000,1)." TONS":number_format($emm,0)." LBS";?></div>
        <div style="float:left; width:70px; margin-left:5px; padding: 2px 0;"><?php $emm = $e_baseline*$co2; echo $emm>4000?number_format($emm/2000,1)." TONS":number_format($emm,0)." LBS";?></div>
        <div class="clear" style="margin-bottom:3px;"></div>

        <div style="float:left; width:70px; margin-left:5px; padding: 2px 0;"><?=number_format($e_consumption*$ch4, 3);?> LBS</div>
        <div style="float:left; width:70px; margin-left:5px; padding: 2px 0;"><?=number_format($e_baseline*$ch4, 3);?> LBS</div>
        <div class="clear" style="margin-bottom:3px;"></div>

        <div style="float:left; width:70px; margin-left:5px; padding: 2px 0;"><?=number_format($e_consumption*$n2o, 3);?> LBS</div>
        <div style="float:left; width:70px; margin-left:5px; padding: 2px 0;"><?=number_format($e_baseline*$n2o, 3);?> LBS</div>
        <div class="clear" style="margin-bottom:20px;"></div>
        ...
        <div style="float:left; width:70px; margin-left:5px; padding: 2px 0;"><?php $emm = $g_consumption*$co2; echo $emm>4000?number_format($emm/2000,1)." TONS":number_format($emm,0)." LBS";?></div>
        <div style="float:left; width:70px; margin-left:5px; padding: 2px 0;"><?php $emm = $g_baseline*$co2; echo $emm>4000?number_format($emm/2000,1)." TONS":number_format($emm,0)." LBS";?></div>
        <div class="clear" style="margin-bottom:3px;"></div>

        <div style="float:left; width:70px; margin-left:5px; padding: 2px 0;"><?=number_format($g_consumption*$ch4, 3);?> LBS</div>
        <div style="float:left; width:70px; margin-left:5px; padding: 2px 0;"><?=number_format($g_baseline*$ch4, 3);?> LBS</div>
        <div class="clear" style="margin-bottom:3px;"></div>

        <div style="float:left; width:70px; margin-left:5px; padding: 2px 0;"><?=number_format($g_consumption*$n2o, 3);?> LBS</div>
        <div style="float:left; width:70px; margin-left:5px; padding: 2px 0;"><?=number_format($g_baseline*$n2o, 3);?> LBS</div>
