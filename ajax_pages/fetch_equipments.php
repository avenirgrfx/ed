...
if (isset($_POST) && !empty($_POST)) {
    if ($_POST['mode'] == "add") {
        ...
        $strSQL = "insert into t_system (parent_id, system_name, complexity, fuel_type_id, category_id, has_gallery, prefix, level) values ('" . $_POST['txtSystemId'] . "', '" . $_POST['txtEquipmentName'] . "', '" . $_POST['txtComplexity'] . "', '" . $_POST['txtFuelTypeId'] . "', '" . $_POST['txtCategoryId'] . "', '" . $_POST['txtHasGallery'] . "', '" . $prefix.$chr . "', 3)";
        $DB->Returns($strSQL);
    } else if ($_POST['mode'] == "delete") {
        $strSQL = "delete from t_system where system_id = '" . $_POST['txtEquipmentId'] . "'";
        $DB->Returns($strSQL);
    } else if ($_POST['mode'] == "update") {
        $strSQL = "update t_system set level = 3, parent_id = '" . $_POST['txtSystemId'] . "', system_name = '" . $_POST['txtEquipmentName'] . "', complexity = '" . $_POST['txtComplexity'] . "', fuel_type_id = '" . $_POST['txtFuelTypeId'] . "', category_id = '" . $_POST['txtCategoryId'] . "', has_gallery = '" . $_POST['txtHasGallery'] . "' where system_id = '" . $_POST['txtEquipmentId'] . "'";
        $DB->Returns($strSQL);
...
<form id="frmSystem" name="frmSystem" action="" method="post">
    ...
    <div style="float:left; width:160px;">
        <select id="ddlComplexity" name="ddlComplexity" style="width:150px;">    	
    ...
    <div style="float:left;">
        <input type="checkbox" value="1" name="chkHasWidget" id="chkHasGallery" /> <label for="chkHasGallery">Add to Gallery</label>
    </div>
    
    <div style="float: right;">
        <input type="button" id="btn_Add" name="btn_Add" value="Add" style="float: right; width: 70px;" onclick="AddNewEquipment()"/>
...
<?php
    ...
    while($strRsCategory=mysql_fetch_object($strRsCategoryArr))
    {
        $strDisconnectStyle = 'color: #000000;';
        if($strRsCategory->exclude_in_calculation == 1)
        {
            $strDisconnectStyle='color: #ff0000; ';
        }
        
        print "<li style='$strDisconnectStyle; width:350px; float:left; margin-right: 50px;'><b> <span>". $strRsCategory->system_name."</span></b><ul>";
        ...
        while($strRsSubCat1=mysql_fetch_object($strRsSubCat1Arr))
        {
            ...
            $strDisconnectStyle = 'color: #000000;';
            if($strRsSubCat1->exclude_in_calculation == 1)
            {
            $strDisconnectStyle='color: #ff0000; ';
            }
            print "<li style='$strDisconnectStyle'><span>".$strRsSubCat1->system_name."</span><ul>";				
            ...
            while($strRsSubCat2=mysql_fetch_object($strRsSubCat2Arr))
            {
                ...
                print "<li style='$strDisconnectStyle;cursor:pointer;'><span style='$strHasNodeStyle' onclick=EditEquipment('".$strRsSubCat2->system_id."')>".$strRsSubCat2->system_name."</span>&nbsp;&nbsp;<span id='".$strRsSubCat2->system_id."'></span></li>";
            }
            print "</ul></li>";
