...
$strSQL = "Select system_node_id, node_serial, custom_name from t_system_node where delete_flag=0 and building_id=".$building_id." and project_id in (Select project_id from t_projects where t_projects.room_id<>0 and building_id=".$building_id.")";
...
<div style="background-color:#FFFFFF; border-radius:10px; height:350px; overflow-y: scroll;" class="myscroll">
    <div style="text-decoration: underline; font-weight: bold; font-size: 20px; padding: 20px; text-align: center;">ROOM NODES</div>
    <div>
