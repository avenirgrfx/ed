...
else if($_POST['mode']=='save')
{
    ...
    /******* update account data ********/
    $strSQL="update t_utility_accounts set utility_name = '$utility_name', utility_account_number = '$utility_account_number', dom = now(), modified_by = '$modified_by' where utility_account_id = '$AccountID'";
    $DB->Execute($strSQL);
    
    /******* update meter data ********/
    $strSQL="update t_utility_account_meters set meter_number = '$meter_number' where utility_meter_number = '$MeterID'";
    $DB->Execute($strSQL);
