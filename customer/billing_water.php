        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                $('#ddlMeterList').change(function(){
                    ...
                    $.get("<?php echo URL ?>ajax_pages/customers/utility_water_account_meter_data.php",
                            {
                                year: $('#ddlBillingSummary2').val(),
...
//                    });
            ...
            function ChangeBuildingDropdown(strBuildingID)
            {
                ...
                $.get("<?php echo URL ?>ajax_pages/customers/building_billing_summary_water.php",
                        {
                            building_id: $('#ddlBuildingForSite').val(),
                            year: $('#ddlMonthlyProfileYear').val(),
                        },
                ...
                $.get("<?php echo URL ?>ajax_pages/customers/building_billing_summary_water_graph.php",
                        {
                            building_id: $('#ddlBuildingForSite').val(),
                            year: $('#ddlMonthlyProfileYear').val(),
                        },
...
//                });
                ...
                $('#water_meter_vs_billed').html('Loading...');
                $.get("<?php echo URL ?>ajax_pages/customers/utility_water_meter_vs_billed.php",
                        {
                            building_id: $('#ddlBuildingForSite').val(),
                            year: $('#ddlMonthlyProfileYear').val(),
                        },
                function (data, status) {
                    $('#water_meter_vs_billed').html(data);
                });
            ...
            function updateBillData(id){
                ...
                $.post("<?php echo URL ?>ajax_pages/customers/utility_water_account_meter_data.php",
                        {
                            'id'            : id,
                    ...
                    <div class="Windows_Main" style="margin-left:35px; border:1px solid #999999; border-radius:10px;">
                        ...
                        <div class="Window_Container_Bg" style="min-height:445px;">
                            ...
                            <div>
                                ...
                                <div style="float:left; margin-left: 9px; font-size: 14px;"><p style="margin: 0;"><a href="<?php echo URL ?>uploads/sample/Accounts_&_Billing_CSV_Water.csv">Download</a> Water Sample CSV</p></div>
                    ...
                    <div style="width:96%; padding:3% 2%; border-radius:10px; min-height:355px; background:-webkit-linear-gradient(180deg, #bbbbbb, white, #bbbbbb); border:1px solid #999999;">
                        ...
                        <div style="background-color:#FFFFFF; height:100%; border:1px solid #CCCCCC; padding:5px; min-height:465px; border-radius:5px;">
                            ...
                            <div style="font-size:16px; margin-left:10px; font-weight:bold;">                        
                                <div style="float:left; width:250px; margin-left:0px;">WATER BILLING</div>
                        ...
                        <div class="Window_Container_Bg">
                            ...
                            <div style="padding:10px 10px 10px 20px; min-height:450px;" id="Large_Graph_Area">        
                                ...
                                <div style="float:left; width:50%; margin-left:4%;">
                                    <div style="font-weight:bold; font-size:18px; margin-left:180px;">WATER METERED VS. BILLED</div>                                

<!--                                    <div style="float:left; width:160px;" id="degree_days_data">
                                        Loading...
                                    </div>-->

                                    <div style="float:left; margin-left:20px; width: 500px; /*width:330px;*/" id="water_meter_vs_billed">
                                        Loading...
                                    </div>
