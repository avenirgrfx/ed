                        ...
                        <div style="margin-left:20px;">
                           ...
                           <div style="float:left; text-decoration:underline; margin-left:10px; width:140px; padding:2px 5px;">BILLED CONSUMPTION</div>
                            ...
                            <div class="clear"></div>
                           	...
                           	<div class="gray_box_for_value" style="float:left; width:141px;">234,5 Therms</div>
                          	<div class="gray_box_for_value" style="float:left; margin-left:10px; width:140px;">234,567 Therms</div>
                           ...
                           <div style="float:left; text-decoration:underline; margin-left:10px; width:140px; padding:2px 5px;">BILLED CONSUMPTION</div>
                            ...
                            <div class="clear"></div>
                          	...
                          	<div style="float:left; margin-left:14px; width:140px;">234,567 Therms</div>
                            ...
                            <div style="float:left; width:150px;">ACCOUNT 2</div>
                          	<div style="float:left; margin-left:14px; width:140px;">127,348 Therms</div>
            	...
            	<div style="width:96%; padding:3% 2%; border-radius:10px; min-height:355px; background:-webkit-linear-gradient(180deg, #bbbbbb, white, #bbbbbb); border:1px solid #999999;">
                    ...
                    <div style="background-color:#FFFFFF; height:100%; border:1px solid #CCCCCC; padding:5px; min-height:300px; border-radius:5px;">
                      ...
                      <div style="font-size:16px; margin-left:10px; font-weight:bold;">                        
                        	<div style="float:left; width:250px; margin-left:0px;">NATURAL GAS  BILLING</div>
                    	...
                    	<div style="padding:10px 10px 10px 20px; min-height:450px;" id="Large_Graph_Area">        
                          ...
                          <div style="border:1px solid #999999; width:500px;">
                                ...
                                <div style="font-weight:bold;">
                                	<div style="float:left; width:40%; color:#801617;">Natural Gas ECI:</div> 
                               	  <div style="float:left; width:50%; color:#801617;"> 0.37 per sq. ft. /yr</div>
                                    <div class="clear"></div>
                                    <div style="float:left; width:40%;">Gas Energy Usage:</div>
                                  <div style="float:left; width:50%;"> 1 ,311,556.2 kBTU/yr</div>
                                    <div class="clear"></div>
                                    <div style="float:left; width:40%; color:#801617;">Natural Gas EUI:</div> 
                                  <div style="float:left; width:50%; color:#801617;">3.32 Therms/sq. ft. /Yr</div>
                                  <div class="clear"></div>
                                    <div style="float:left; width:40%;">Average Cost:</div>
                                  <div style="float:left; width:50%;"> $ 0 .112 /Therm</div>
                                    <div class="clear"></div>
                                </div>
                            ...
                            <div style="float:left; width:50%; margin-left:4%;">
                            	<div style="font-weight:bold; font-size:18px; margin-left:180px;">NATURAL GAS  METERED VS. BILLED</div>                                
