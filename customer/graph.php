                ...
                $('#ddlGraphType').change(function () {
                    ...
                    } else if (this.value == 2)
                    {
                        ...
                        $.get("<?php echo URL ?>ajax_pages/customers/node_list_by_building.php",
                        {
                            ...
                            graphtype: $('#ddlConsumption_Chart').val(),
                        },
                        function (data, status) {
                    ...
                    } else if (this.value == 3)
                    {
                        ...
                        $.get("<?php echo URL ?>ajax_pages/customers/node_list_by_building_disconnect.php",
                        {
                            building_id: $('#ddlBuildingConsoleList').val(),
                            graphtype: $('#ddlCost_Chart').val(),
                        },
                        function (data, status) {
                            $('#ddlNodesForChartList').html(data);
                        });
...
<!--                                    <option value="3">COST BY SYSTEM</option>
                        ...
                        <div style="margin-top:10px; display:none;" id="Graph_Type_Bottom_Options_3">
                            <div class="benchmark_button benchmark_button_active" style="float:left;  cursor:pointer;" id="Electric_Cost_Button">Electric Disconnect</div>
                            <div style="float:left; margin-left:10px; padding:5px;">|</div>           
                            <div class="benchmark_button" style="float:left; margin-left:10px; padding:5px; cursor:pointer;" id="Natural_Gas_Cost_Button">Natural Gas Disconnect</div>                       
                            <div class="clear"></div>
                        </div>
