...
<!--                        <div class="Window_Title_Bg">
                        ...
                        <div class="Window_Title_Bg">
                            ...
                            <div style="float:right; margin-top:20px; margin-right:20px; color: rgb(102, 102, 102); font-size: 18px;">
                                <div>
                                    <select id="ddlSitesPortfolio1" style="width:200px; font-size:16px; font-weight:bold; font-family: UsEnergyEngineers;" onchange="ChangeSiteDropdown(this.value)">
                                    <?php while ($rsSite = mysql_fetch_object($rsSiteArr)) {
                                        echo "<option value='$rsSite->site_id'>SITE - $rsSite->site_name</option>";
                                    }?>
                                    </select>
                ...
                <div id="Customer_Right_Panel" style="min-height:500px;">
                    ...
                    <div style="width:94%; padding:3%; border-radius:10px; min-height:300px; background:-webkit-linear-gradient(180deg, #bbbbbb, white, #bbbbbb); border:1px solid #999999;">
                        <div class="switch_button" id="site_utility1" style="margin-left: 360px; margin-top: -10px;">
                            <input type="checkbox" value="1" id="chkSite_utility1" name="chkSite_utility1" />
                        </div>
                        ...
                        <div style="margin-top:10px;">
                            ...
                            <div id="portfolio_link" style="float:right; background-color:#A9A9A9; border-radius:10px; padding:5px 5px; border:1px solid #CCCCCC; width:120px; text-align:center;">
                                <a href="javascript:void(0);" style="cursor: default;" onclick="if($('#j_username').val()!=''){$('#loginForm').submit();}"><img src="<?php echo URL ?>/images/portfolio_manager_logo.png" border="0" /></a>
                            </div>
                            <form target="_blank" action="https://portfoliomanager.energystar.gov/pm/j_spring_security_check" name="loginForm" id="loginForm" method="post" class="margin-top-20" style="display:none;">
                                <div style="margin-left: 100px; width:100px;float:left; padding-top:5px">Username:</div>
                                <span class="required-indicator">*</span>
                                <input type="text" style="width:190px;" class="text" value="" id="j_username" name="j_username"><br>

                                <div style="margin-left: 100px; width:100px;float:left; padding-top:5px">Password:</div>
                                <span class="required-indicator">*</span>
                                <input type="password" style="width:190px;" class="text" value="" id="j_password" name="j_password"><br>

                                <div style="margin-left: 200px; margin-right: 10px;" class="float-l" id="forgot-links">
                                    <small><a href="/pm/account/help/password">
                                        I forgot my password.</a></small> <br>
                                    <small><a href="/pm/account/help/username">
                                        I forgot my username.</a></small>
                                </div>
                                <div id="form-buttons">
                                    <input type="submit" id="button-login" value="Sign In" class="big-button">
                                </div>
                            </form>
                            <div class="clear"></div>
                        </div>
...
<!--                        <div class="Window_Title_Bg">
                        ...
                        <div class="Window_Title_Bg">
                            ...
                            <div style="float:right; margin-top:20px; margin-right:20px; color: rgb(102, 102, 102); font-size: 18px;">
                                <div>
                                    <select id="ddlSitesPortfolio2" style="width:200px; font-size:16px; font-weight:bold; font-family: UsEnergyEngineers;" onchange="ChangeSiteDropdown(this.value)">
                                    <?php while ($rsSite = mysql_fetch_object($rsSiteArr)) {
                                        echo "<option value='$rsSite->site_id'>SITE - $rsSite->site_name</option>";
                                    }?>
                                    </select>
                        ...
                        <div class="Window_Container_Bg">
                            ...
                            <div style="padding:15px 10px 10px 20px; min-height:600px;">
                ...
                <div id="Customer_Right_Panel">
                    ...
                    <div style="width:94%; padding:3%; border-radius:10px; min-height:300px; background:-webkit-linear-gradient(180deg, #bbbbbb, white, #bbbbbb); border:1px solid #999999;">
                        <div class="switch_button" id="site_utility2" style="margin-left: 360px; margin-top: -10px;">
                            <input type="checkbox" value="1" id="chkSite_utility2" name="chkSite_utility2" />
                        </div>
                        <div style="background-color:#FFFFFF; height:100%; border:1px solid #CCCCCC; padding:5px; min-height:650px; border-radius:5px;">
...
<!--                                <div style="float:left; margin-left:40px; margin-top: -20px;">
                                    <div style="flaot:left;"><input type="radio" name="show_type" value="1" id="actual" checked><label for="actual">Actual</label></div>
                                    <div style="flaot:left;"><input type="radio" name="show_type" value="2" id="utility"><label for="utility">Utility</label></div>
                                </div>-->
