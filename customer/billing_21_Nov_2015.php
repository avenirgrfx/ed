                    ...
                    <div class="Windows_Main" style="margin-left:35px; border:1px solid #999999; border-radius:10px;">
                        ...
                        <div class="Window_Container_Bg" style="min-height:365px;">
                            ...
                            <div>
                                ...
                                <div style="padding:3px; border:1px solid #666666; border-radius:3px; text-align: center; font-weight: bold; margin-bottom:3px; float:left; margin-left:10px;" title="Create account & import bill through CSV.">CSV IMPORT</div>
                                <div style="float:left; margin-top: 4px;  margin-left: 10px;"><a href="<?php echo URL ?>uploads/sample/Accounts%20&%20Billing%20CSV%20Sample.csv">Download</a> Sample CSV</div>
