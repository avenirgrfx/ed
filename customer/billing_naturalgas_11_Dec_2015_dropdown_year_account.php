        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                $('#ddlMeterList').change(function(){
                    ...
                    $.get("<?php echo URL ?>ajax_pages/customers/utility_gas_account_meter_data.php",
                            {
                                year: $('#ddlBillingSummary2').val(),
            ...
            function ChangeBuildingDropdown(strBuildingID)
            {
                ...
                $.get("<?php echo URL ?>ajax_pages/customers/building_billing_summary_gas.php",
                        {
                            building_id: $('#ddlBuildingForSite').val(),
                            year: $('#ddlMonthlyProfileYear').val(),
                        },
                ...
                $.get("<?php echo URL ?>ajax_pages/customers/building_billing_summary_gas_graph.php",
                        {
                            building_id: $('#ddlBuildingForSite').val(),
                            year: $('#ddlMonthlyProfileYear').val(),
                        },
                ...
                $('#gas_meter_vs_billed').html('Loading...');
                $.get("<?php echo URL ?>ajax_pages/customers/utility_gas_meter_vs_billed.php",
                        {
                            building_id: $('#ddlBuildingForSite').val(),
                            year: $('#ddlMonthlyProfileYear').val(),
                        },
                function (data, status) {
                    $('#gas_meter_vs_billed').html(data);
                });
            ...
            function updateBillData(id){
                ...
                $.post("<?php echo URL ?>ajax_pages/customers/utility_gas_account_meter_data.php",
                        {
                            'id'            : id,
                        ...
                        <div class="Window_Container_Bg">
                            ...
                            <div style="padding:10px 10px 10px 20px; min-height:450px;" id="Large_Graph_Area">        
                                ...
                                <div style="float:left; width:50%; margin-left:4%;">
                                    ...
                                    <div style="float:left; margin-left:20px; width:330px;" id="gas_meter_vs_billed">
                                        Loading...
                                    </div>
