...
(function(global) {
  ...
  fabric.Object = fabric.util.createClass(/** @lends fabric.Object.prototype */ {
	...
	widget_value3:0,
	widget_serial:false,
	/* Added for Widget Type*/
	
    stateProperties:  (
      'top left width height scaleX scaleY flipX flipY originX originY transformMatrix ' +
      'stroke strokeWidth strokeDashArray strokeLineCap strokeLineJoin strokeMiterLimit ' +
      'angle opacity fill fillRule globalCompositeOperation shadow clipTo visible backgroundColor is_widget widget_value1 widget_value2 widget_value3 widget_serial'
    ).split(' '),
    ...
    toObject: function(propertiesToInclude) {
      var NUM_FRACTION_DIGITS = fabric.Object.NUM_FRACTION_DIGITS,
          ...
          object = {
			...
			widget_value1:			  this.widget_value1,
			widget_value2:			  this.widget_value2,
			widget_value3:			  this.widget_value3,
			widget_serial:			  this.widget_serial,
