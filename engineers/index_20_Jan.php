...
(function() {
 ...
 <div id="SystemNodeSetup_Container" style="position:relative;"> 
      ...
      <!-- System Node Container -->
		<div id="SystemNodeSetup_Container_Div" style="width:600px; position:absolute; height:300px; border:1px solid #666666; display:none; right:0px; top:100px; background-color:#FFFFFF;"></div>
	<!-- System Node Container -->
