...
(function() {
  ...
  <div id="ProjectSetup_Container" style="display:none; position:relative;">
    ...
    <div onClick="javascript:Check();" id="project_details" style="width:500px; height:0px; display:none; position:absolute; border:1px solid #666666; right:0px; top:0px; background-color:#FFFFFF; opacity: 0.7;
